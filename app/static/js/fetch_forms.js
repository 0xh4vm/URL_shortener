        ...
        const func = (e) => {
            ...
            fetch(form_obj.url, {
                ...
                .then(json => {
                    ...
                    document.getElementById('result-url').innerText = window.location.origin+'/'+json['short_url'];
                    document.getElementById('result-url').setAttribute('href', window.location.origin+'/'+json['short_url']);
